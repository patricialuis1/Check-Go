...
|-----|------------------|
| **@Ricardolenovo153** | Backend Node.js, Supabase, CI/CD, GitHub Actions, Deploy na Vercel, README |
| **@patricialis1** | Ajuda com documentação, Deploy na Vercel, README |

---

> **Projeto em desenvolvimento** – Próximos passos: Frontend React + Auth com Supabase